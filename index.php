...
<head>
  ...
  <title>Aplikasi Pengaduan Masyarakat | Raffy Mochamad Fathur </title>
...
<body style="background-image: url('assets/img/images.jpeg');">
  ...
  <footer class="footer mt-3 py-2 bg-light fixed-bottom">
    <div class="container">
      <p class="text-center">UKK RPL 2023 | Raffy Mochamad Fathur | SMKN 1 KARAWANG</p>
    </div>
  </footer>
